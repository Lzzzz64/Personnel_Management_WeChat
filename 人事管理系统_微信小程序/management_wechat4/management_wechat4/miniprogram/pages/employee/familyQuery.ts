Page({
  ...
  savePosition: function () {
    ...
    const relationData = this.data.employee.relation;
    console.log(employee);
     ...
     employee.relation.forEach(relation => {
       if (relationship !== '') relation.relationship = relationship;
       if (name !== '') relation.name = name;
       if (organization !== '') relation.organization = organization;
       if (phone !== '') relation.phone = phone;
     });
